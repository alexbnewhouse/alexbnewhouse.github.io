...
::: {.stat-tile}
[15]{.stat-num}
[Independent projects]{.stat-label}
:::
::: {.stat-tile}
[3]{.stat-num}
...
::: {.stat-tile}
[6]{.stat-num}
[Open R tutorials]{.stat-label}
:::
:::

My teaching portfolio centers on quantitative methods, computational social science, political violence, and technology & politics. I have taught self-designed courses at Middlebury College and MIIS, served as a TA across the CU Boulder political science curriculum, and built open R tutorials for students with no prior coding background.

::: {.action-row}
[Browse tutorials](tutorials.html){.btn .btn-primary}
[Teaching statement](teaching-statement.html){.btn .btn-secondary}
[Sample syllabus](intd1027-syllabus.html){.btn .btn-secondary}
:::
...
I develop original, open-source educational materials for my courses, designed to make quantitative methods accessible to students with no prior coding or statistics experience. These tutorials are used in CU Boulder's PSCI 2075 course and are freely available — [browse the full tutorial hub](tutorials.html).
