...
**Fall 2025** - **PSCI 2075: Quantitative Methods** - [Tutorial 1: Getting Started with R](/tutorial1.qmd)
...
**January 2021** - **Online Extremism** (self-designed) - Intensive winter term course on digital radicalization - Focus on methodological approaches to studying online political violence - Integration of computational methods with political science theory

## Teaching Materials & Resources

### Quantitative Methods Resources

-   [Tutorial 1: Getting Started with R](/tutorial1.qmd) - Introduction to R programming for political science research
-   Data visualization techniques for political analysis
-   Causal inference methods in observational data

### Student Mentorship

I have extensive experience mentoring student researchers, having supervised **30 undergraduate and graduate research assistants** and **15 independent projects** between 2019-2023. Student projects have covered topics including:
...
Through partnerships with technology companies and government agencies, students gain exposure to real-world applications of political science research in policy and industry settings.