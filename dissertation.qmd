...
description: "Alex Newhouse's dissertation on collective mobilization in online extremist communities, combining NLP, network analysis, and causal inference."
format:
  html:
    toc: true
    toc-location: right
...
I study how decentralized online extremist communities generate collective mobilization despite organizational fragmentation and geographic dispersion. The project combines transformer NLP, network analysis, interrupted time series, and regression with novel datasets from 4chan, Iron March, and mass-casualty attack archives.

::: {.action-row}
[Download prospectus](prospectus.pdf){.btn .btn-primary}
[Email about the project](mailto:alex.newhouse@colorado.edu?subject=Dissertation%20inquiry){.btn .btn-secondary}
:::
:::
...
::: {.stat-tile}
[Apr. 2026]{.stat-num}
[Prospectus defended]{.stat-label}
:::
::: {.stat-tile}
[3]{.stat-num}
[Empirical chapters]{.stat-label}
:::
::: {.stat-tile}
[May 2028]{.stat-num}
[Expected defense]{.stat-label}
:::
:::
...
I have supervised **52 undergraduate and graduate research assistants** across my research career, and I actively seek to integrate students into all stages of the research process.
...
- [Andrew Q. Philips](https://www.colorado.edu/polisci/andrew-philips), Department of Political Science, CU Boulder
- [Jennifer Fitzgerald](https://www.colorado.edu/polisci/jennifer-fitzgerald), Department of Political Science, CU Boulder

**Members:**

- [Alexandra Siegel](https://www.colorado.edu/polisci/alexandra-siegel), Department of Political Science, CU Boulder
- [Brian Keegan](https://www.colorado.edu/cmci/people/information-science/brian-keegan), Department of Information Science, CU Boulder (external advisor)

---

## Dissertation Prospectus

The prospectus, defended April 14, 2026, is available as a PDF: [Download Prospectus (PDF)](prospectus.pdf).
...
|-----------|-------------|
| Prospectus Defense | Completed (April 14, 2026) |
| Chapter 2 Draft | Summer 2026 |
| Chapter 3 Draft | Fall 2026 |
| Chapter 4 Draft | Spring 2027 |
| Revision & Job Market Period | AY 2027–2028 |
| Defense | May 2028 |
