...
- **Chapter 1 (Network Structures):** Students can assist with data collection from public forums, network data coding, and replication of network analysis measures
- **Chapter 2 (Ideological Convergence):** Students can contribute to qualitative coding of extremist texts, annotation for text classification training data, and topic model validation
- **Chapter 3 (Platform Affordances):** Students can help with cross-platform data collection, content analysis, and documentation of platform policy changes
