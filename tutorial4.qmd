...
1.  Try log-transforming the population variable and compare the distribution
2.  Create a three-category democracy variable (Low/Medium/High) using quantile cuts
3.  Identify and investigate the countries with the highest democracy scores
4.  Create a scatter plot matrix comparing original and transformed variables